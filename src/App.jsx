...
const instructors = [
  ...
  { name: "Santosh Kumar", title: "Lead Instructor, Cyber Security, Cloud & DevOps", expertise: "AWS Certified, 10 years in across cloud and security domain.", avatar: "https://placehold.co/200x200/4A5568/E2E8F0?text=SK" },
...
const ContactForm = ({ initialCourse }) => {
    const [selectedCourse, setSelectedCourse] = useState(initialCourse || 'cyber-security');
            ...
            <form action="https://formspree.io/f/YOUR_FORM_ID" method="POST" className="contact-form rounded-lg p-8 max-w-xl mx-auto text-left">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input type="tel" name="phone" id="phone" className="mt-1 block w-full bg-gray-600 border-gray-500 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-coral-500 focus:border-coral-500 text-white"/>
                    </div>
                    <div className="md:col-span-2">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <textarea id="message" name="message" rows="4" required className="mt-1 block w-full bg-gray-600 border-gray-500 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-coral-500 focus:border-coral-500 text-white"></textarea>
                    </div>
                </div>
                <div className="mt-6">
...
const Testimonials = () => {
    ...
    return (
        ...
        >
            <button onClick={() => scroll('left')} className="scroll-arrow absolute left-0 top-1/2 -translate-y-1/2 bg-gray-800/50 p-2 rounded-full z-10 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <button onClick={() => scroll('right')} className="scroll-arrow absolute right-0 top-1/2 -translate-y-1/2 bg-gray-800/50 p-2 rounded-full z-10 opacity-0 group-hover:opacity-100 transition-opacity">
