...
const Footer = ({ navigateTo }) => (
    <footer className="bg-black/50 text-white py-8">
        <div className="container mx-auto px-6 text-center">
            ...
            <div className="flex justify-center space-x-6 mb-4">
                <a href="#" onClick={(e) => { e.preventDefault(); navigateTo('home'); }} className="text-sm text-gray-400 hover:text-white">Home</a>
                <a href="#" onClick={(e) => { e.preventDefault(); navigateTo('dashboard'); }} className="text-sm text-[#ff7f50] hover:text-white font-bold">Dashboard</a>
                <a href="#" onClick={(e) => { e.preventDefault(); navigateTo('events'); }} className="text-sm text-gray-400 hover:text-white">Events</a>
                <a href="#" onClick={(e) => { e.preventDefault(); navigateTo('resources'); }} className="text-sm text-gray-400 hover:text-white">Resources</a>
                <a href="#" onClick={(e) => { e.preventDefault(); navigateTo('blog'); }} className="text-sm text-gray-400 hover:text-white">Blog</a>
