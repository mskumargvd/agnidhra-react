        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
            <div className="bg-gray-800 p-6 rounded-lg shadow-2xl w-11/12 max-w-4xl relative">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <img 
                        src="https://placehold.co/400x600/1f2937/ff7f50?text=Promo+Image+1" 
                        alt="Promotional Image 1" 
                        className="rounded-lg cursor-pointer hover:opacity-90 transition-opacity"
                        onClick={handleImageClick}
                    />
                    <img 
                        src="https://placehold.co/400x600/1f2937/ff7f50?text=Promo+Image+2" 
                        alt="Promotional Image 2" 
                        className="rounded-lg cursor-pointer hover:opacity-90 transition-opacity"
                        onClick={handleImageClick}
                    />
                    <img 
                        src="https://placehold.co/400x600/1f2937/ff7f50?text=Promo+Image+3" 
